...
// Importa el archivo SVG como un módulo estático
import logo from "/public/familia.svg";
      ...
      <nav className="bg-yellow-400 p-4">
        <div className="container mx-auto flex justify-between items-center">
          <div className="text-2xl font-bold text-sky-900">
            {/* 1. Prioriza el logo para que se cargue de inmediato */}
            <Image
              src={logo}
              width={150}
              height={100}
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              {/* 2. El ícono se cargará antes debido al "use client" */}
